  ...
  return (
    <main>
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-orange-50 to-transparent" id="hero">
            <div className="max-w-4xl mx-auto px-6 pt-6 pb-32 flex flex-col" id="hero-container">
                ...
                <p className="text-xl mt-4">Take your web app codebase and transfrom it into a cross platform desktop app with native fucntionality</p>
